...
// Tamanho e posiÁaoo inicial do quadrado
GLfloat x1 = 100.0f;
GLfloat y1 = 150.0f;
GLsizei rsize = 50;                                                    

// Tamanho do incremento nas direÁoes x e y 
...
// FunÁao callback chamada para fazer o desenho
void Desenha(void)
{
     glMatrixMode(GL_MODELVIEW);
     glLoadIdentity();
                   
     // Limpa a janela de visualizaÁao com a cor de fundo especificada
     ...
     glBegin(GL_QUADS);
               ...
               glVertex2i(x1,y1);
               // Especifica que a cor corrente È azul
...
void Timer(int value)
{
    ...
    // Muda a direÁao quando chega na borda superior ou inferior
    if(y1 > windowHeight-rsize || y1 < 0)
          ystep = -ystep;
          
    // Verifica as bordas.  Se a window for menor e o 
    // quadrado sair do volume de visualiza√ß√£o 
...
{
     glutInit (&argc, argv);//inicializa a biblioteca da glut
