...
public class Cube extends AutoDrawnableObject {
	...
	// cube
		...
		float altura = 0.8f; ///Z
		float base = 1.5f; //X
		float profundidade = 0.5f; //Y

		// vertex coords array
		float vertices[] = { 0, 0, altura, 0, -base, altura, profundidade, -base,altura, profundidade, 0, altura, // v0-v1-v2-v3
				profundidade, 0, altura, profundidade, -base, altura, profundidade, -base, 0, profundidade, 0, 0f, // v0-v3-v4-v5
				profundidade, -base, altura, 0, -base, altura, 0, -base, 0f, profundidade, -base, 0f, // v0-v5-v6-v1
				0, 0, altura, 0, 0, 0f, 0, -base, 0, 0, -base, altura, // v1-v6-v7-v2
				0, 0, altura, profundidade, 0, altura, profundidade, 0, 0, 0, 0, 0}; // v4-v7-v6-v5
