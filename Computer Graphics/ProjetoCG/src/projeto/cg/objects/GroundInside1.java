...
public class GroundInside1 extends AutoDrawnableObject {
	...
	// vertex coords array
	float vertices[] = { 0, 0, 0f, 0, -21f, 0f, 21f, -21f, 0f, 21f, 0, 0f, // v0-v1-v2-v3
			21f, 0, 0f, 21f, -21f, 0f, 21f, -21f, 0, 22f, 0, 0f, // v0-v3-v4-v5
			21f, -21f, 0f, 0, -22f, 0f, 0, -22f, 0f, 21f, -21f, 0f, // v0-v5-v6-v1
			0, 0, 0f, 0, 0, 0f, 0, -22f, 0, 0, -21f, 0f, // v1-v6-v7-v2
			0, 0, 0f, 22f, 0, 0f, 22f, 0, 0, 0, 0, 0}; // v4-v7-v6-v5
